...
ERROR_STATUS_BY_CODE: Mapping[str, int] = MappingProxyType(
    {
        ...
        "TOOL_CONTEXT_MISMATCH": HTTPStatus.CONFLICT,
        "TOOL_UNAVAILABLE": HTTPStatus.SERVICE_UNAVAILABLE,
        "TOOL_VERSION_MISMATCH": HTTPStatus.CONFLICT,
        "TOOL_DEFINITION_MISMATCH": HTTPStatus.CONFLICT,
        "TOOL_INPUT_VALIDATION_FAILED": HTTPStatus.UNPROCESSABLE_ENTITY,
        "TOOL_OUTPUT_VALIDATION_FAILED": HTTPStatus.UNPROCESSABLE_ENTITY,
        "TOOL_TIMEOUT": HTTPStatus.GATEWAY_TIMEOUT,
        "TOOL_EXECUTION_FAILED": HTTPStatus.INTERNAL_SERVER_ERROR,
        "TOOL_CALL_ALREADY_EXISTS": HTTPStatus.CONFLICT,
        "MODEL_GATEWAY_FAILED": HTTPStatus.BAD_GATEWAY,
        "MODEL_PROTOCOL_INVALID": HTTPStatus.BAD_GATEWAY,
        "MODEL_TURN_LIMIT_EXCEEDED": HTTPStatus.GATEWAY_TIMEOUT,
