...
**当前阶段**：Alpha / M5.5 正式实验冻结审批阶段；第三次 Pilot 证据已封存，正式 launcher 与盲评工具已通过离线 240-run 门禁，M5.6 尚未授权
